...
<div class="container" id="men"><br>
  ...
  <form class="form-horizontal " action="traitConnexionpat.php" method="post">
    <div class="form-group">
      <label for="userpatient">Nom d'utilisateur :</label>
      <input type="text" class="form-control" id="userpatient" name="userpatient" required>
    </div>
    <div class="form-group">
      <label for="psw">Mot de passe :</label>
      <input type="password" class="form-control" id="psw" placeholder="Entrez votre mot de passe" name="psw" required>
    </div>
    <div >
    <?php
if (isset($_SESSION["authpat"]) and $_SESSION["authpat"]==false) {
    echo '<h5 style="color:rgb(177, 10, 20);"><span class="glyphicon glyphicon-exclamation-sign"></span><b>Si vous avez déjà activé votre compte,votre  mot de passe  ou nom d\'utilisateur est incorrect!  Veuillez réessayez SVP</b> </h5>';
    $_SESSION["authpat"]=null;
}
     ?>
    </div>
