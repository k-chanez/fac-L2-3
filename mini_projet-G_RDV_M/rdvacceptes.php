             ...
             <a href="gerecompte.php"> <img id="personne"src="img/images.png" alt="compte"></a>
                ...
                <div class="col-xs-6">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="meserdv.php"><span class="glyphicon glyphicon glyphicon-time" aria-hidden="true " ></span> <b><u> Mes rendez-vous</u></b></a></li>
                    </ul>
                </div>
            </nav>
      <br><br>
...
<div class="col-md-12">
    <div  class=" col-md-4">
        <ul  class="nav">
            <li id="vert" style=background-color:rgb(7,151,7) ;><a href="rdvacceptes.php"> <b>Rendez-vous accéptés</b></a></li>
            <li id="orange"><a href="rdvenattente.php"> Rendez-vous en attentes </a></li>
            <li id="rouge"><a href="rdvrefuses.php"> Rendez-vous refusés </a></li>
        </ul>
        <br><br>
    </div>
    <div  class="cadrevert col-md-offset-2 col-md-6">
        hkjcwhjkh
        wslckjwkljc
        wclkjckwj <br>
        ijqzuhfdsqhujh <br>
