...
<div class="col-md-12">
    <div  class=" col-md-4">
        <ul  class="nav">
            ...
            <li id="orange" style=background-color:rgba(235,154,5,0.986);><a href="rdvenattente.php"> <b>Rendez-vous en attentes</b> </a></li>
            <li id="rouge"><a href="rdvrefuses.php"> Rendez-vous refusés </a></li>
        </ul>
        <br><br>
    </div>
    <div  class="cadreorange col-md-offset-2 col-md-6">
        hkjcwhjkh
        wslckjwkljc
        wclkjckwj <br>
        ijqzuhfdsqhujh <br>
